...
2008年，我还是学生时，在寒暑假及周末会在台式电脑上自学一些感兴趣的技术——黑客技术，主要是远程控制，即RAT(Remote Administration Tool)。

当时听过的网站名字：暗组、夜莺海盗盟、华中帝国、黑鹰基地、黑白网络、E网情深、甲壳虫技术论坛等。
当时听过的软件名字：灰鸽子远程控制(delphi写的)、极光远控、Ghost、白金远控(2011)、等。
